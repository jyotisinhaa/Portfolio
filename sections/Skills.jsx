...
const TechStack = () => {
  ...
  return (
    <Fragment>
      <section
        className="shadow-zinc-300 dark:shadow-zinc-700 shadow-sm overflow-hidden bg-[#0A0A0A] py-12"
        id="techStack"
        ref={techStackRef}
      >
        <h2 className="text-3xl font-bold text-center p-4 flex justify-center items-center gap-3 text-white">
